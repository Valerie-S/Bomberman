...
public class Player1 extends Character {
	...
	private Image moveDown = Toolkit.getDefaultToolkit().createImage("image/player1Down.png");
	private Image moveLeft = Toolkit.getDefaultToolkit().createImage("image/player1Left.png");
	private Image moveRight= Toolkit.getDefaultToolkit().createImage("image/player1Right.png");
	private Image moveUp=Toolkit.getDefaultToolkit().getImage("image/player1Up.png");;
